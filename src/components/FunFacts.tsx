...
const FACTS: { icon: IoniconsName; text: string; source: string }[] = [
  ...
  { icon: 'happy-outline', text: 'Laughing during labor can help release endorphins \u2014 natural painkillers.', source: 'Dunbar et al., Proc. Royal Society B, 2012' },
  ...
  { icon: 'moon-outline', text: 'Between contractions is the perfect time to rest. Even a few seconds helps.', source: 'Simkin, The Birth Partner, 5th Ed.' },
