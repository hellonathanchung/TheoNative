...
const s = StyleSheet.create({
  ...
  supportSection: { paddingHorizontal: 20, paddingTop: 8 },
  ...
  version: { textAlign: 'center', fontSize: 11, color: Colors.textMuted, paddingTop: 8, opacity: 0.6 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(46,59,46,0.4)', alignItems: 'center', justifyContent: 'center', padding: 24 },
  modalCard: { backgroundColor: Colors.cream, borderRadius: 20, padding: 28, width: '100%', maxWidth: 320, alignItems: 'center' },
